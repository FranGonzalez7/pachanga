...
**Pachanga** es una app móvil para organizar partidos de fútbol entre amigos: grupos privados, alineaciones tácticas sobre el campo, puntuación en vivo y una clasificación que premia jugar en equipo. Construida con Flutter y Firebase.
